...
HelpScreen::HelpScreen(EventManager& t_eventManager, CommandSystem& t_commandSystem, InputSystem& t_input, RenderSystem& t_renderSystem) :
...
void HelpScreen::initialise(SDL_Renderer* t_renderer, Controller& t_controller)
{
...
void HelpScreen::setControllerButtonMaps()
{
